  ...
  _createItemList: function(state) {
    return $.map(
      ...
      function(item, index) {
        ...
        if ($item[0].querySelector('.selling-plan-details') !== null) {
			typeof item.selling_plan_allocation !== 'undefined' ? $item[0].querySelector('.selling-plan-details').innerText = item.selling_plan_allocation.selling_plan.name : $item[0].querySelector('.selling-plan-details').innerText = '';
 		}
